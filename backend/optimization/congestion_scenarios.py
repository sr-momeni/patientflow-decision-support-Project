"""Definitions of operational scenarios for CTAS 1–5 MVP."""
...
def _build_scenarios() -> Dict[str, ScenarioConfig]:
    ...
    normal = ScenarioConfig(
        ...
        arrival_rates_per_hour={1: 2.0, 2: 8.0, 3: 12.0, 4: 10.0, 5: 6.0},
    ...
    moderate_congestion = ScenarioConfig(
        name="moderate_congestion",
        description="ED beds somewhat saturated.",
        ed_beds=40,
        icu_beds=15,
        physicians=8,
        nurses=20,
        lab_slots_per_hour=20,
        imaging_slots_per_hour=14,
        arrival_rates_per_hour={1: 2.0, 2: 10.0, 3: 15.0, 4: 12.0, 5: 8.0},
        senior_staff_available=True,
        ed_near_full_threshold=0.85,
        ed_util_alert=0.9,
        icu_util_alert=0.9,
    ...
    ed_congestion = ScenarioConfig(
        ...
        arrival_rates_per_hour={1: 2.2, 2: 12.0, 3: 20.0, 4: 16.0, 5: 10.0},
        senior_staff_available=True,
    ...
    icu_bottleneck = ScenarioConfig(
        ...
        lab_slots_per_hour=22,
        imaging_slots_per_hour=14,
        arrival_rates_per_hour={1: 3.0, 2: 9.0, 3: 12.0, 4: 9.0, 5: 5.0},
        senior_staff_available=True,
        ed_near_full_threshold=0.9,
        ed_util_alert=0.9,
        icu_util_alert=0.9,

                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
                            ...
                            <div className="triage-card">
                                ...
                                <div className="triage-grid-2">
                                    ...
                                    <label className="option-box"><input type="radio" name="presenting_complaint_Main_Concern" value="Braething difficulty" onChange={handleChange}/> Breathing difficulty</label>
